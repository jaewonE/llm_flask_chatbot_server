...
def list_all_history():
    ...
    return jsonify({'status': 'success', 'message': 'All chat histories retrieved successfully.', 'data': {
        'history_list': response_list,
        'available_models': able_model_list}})
...
def list_user_history(user_name):
    ...
    return jsonify({'status': 'success', 'message': 'User chat histories retrieved successfully.', 'data': {
        'history_list': response_list,
        'available_models': able_model_list}})
